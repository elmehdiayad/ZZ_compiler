...
# ./compile.sh <my_flex_file>.lex <my_syntactic_analyzer_file>.c <errors_file.c> <tab_symb_file.c> <my_executable_file_name>
...
gcc -o "$5" lex.yy.o "$file_name2.o" "$file_name3.o" "$file_name1.o"
rm lex.yy.c *.o
